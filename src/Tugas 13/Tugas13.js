            ...
            <>
                ...
                <div id="form-content">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <input type="text" name='harga' value={this.state.input.harga} onChange={this.handleChange} placeholder="Masukan Harga" /><br /><br />
                        <label>Berat Buah : </label>
                        <input type="text" name='berat' value={this.state.input.berat} onChange={this.handleChange} placeholder="Masukan Berat" /><br /><br />
